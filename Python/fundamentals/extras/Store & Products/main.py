...
smartphone = Product(1, "Samsung S20", "Smatphone", 1500)
earbuds = Product(2, "Xiaomi Mi True", "Earbuds", 150)
laptop1 = Product(3, "Dell-XPS", "Laptop", 3000)
laptop2 = Product(4, "Asus-Tuf", "Laptop", 2000)

print("Products in the store")
print("------------------------------------------------------------------")
it_store.add_product(smartphone).add_product(earbuds).add_product(laptop1).add_product(laptop2)
it_store.show_all_products()
print("------------------------------------------------------------------")
it_store.sell_product(3)
